...
import com.shamengxin.ajax.beans.Student;
...
public class AjaxRequest5Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //连接数据库，查询学员信息，拼接HTML代码，响应HTML代码到浏览器（这里就不在连接数据库了，写死了）
        ...
        //能不能直接将数据返回，给WEB前端数据就行。让WEB前端能够拿到数据就行，然后页面展示的功能交割WEB前端来处理。
        ...
        html.append("<td>39</td>");
        html.append("<td>湖北</td>");
        html.append("</tr>");

        out.print(html);*/

        //将以上程序拼接HTML，换成拼接JSON格式的字符串
        // String jsonstr="[{\"name\":\"王五\",\"age\":\"20\",\"addr\":\"武汉洪山\"},{\"name\":\"李四\",\"age\":\"22\",\"addr\":\"武汉硚口\"}]";

        //准备StringBuilder对象，拼接JSON
        StringBuilder json = new StringBuilder();
        String jsonStr="";

        //连接数据库，查询所有的用户，拼接json字符串
